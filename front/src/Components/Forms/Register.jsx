...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const { name, studentId, email, password, password_confirmation, acceptTerms } = formData;

    if (!name.trim() || !studentId.trim() || !email.trim() || !password || !password_confirmation) {
      ...
      <section className="register-form">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <p className="register-error" style={{ minHeight: '1.5em' }}>
            {errorMessage || (authError && typeof authError === 'string' ? authError : authError && Object.values(authError)[0])}
          </p>

          <button type="submit" className="register-register-btn" disabled={loading}>
